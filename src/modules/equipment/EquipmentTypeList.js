...
import {ROUTE_EQUIPMENT_TYPE_EDIT, ROUTE_EQUIPMENT_TYPE_NEW} from '../../utils/routes';
    ...
    return (
        <ContainerWrapper>
            <View style={styles.header}>
                <TouchableOpacity
                    onPress={() => {
                        navigation.navigate(ROUTE_EQUIPMENT_TYPE_NEW, {
                            onLoad: onLoad
                        })
                    }}
                >
                        ...
                        <View style={[
                            ...
                            <View style={styles.cellAction}>
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        navigation.navigate(ROUTE_EQUIPMENT_TYPE_EDIT, {
                                            data: item,
                                            onLoad: onLoad
                                        })
                                    }}

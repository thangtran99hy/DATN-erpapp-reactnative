...
import {ROUTE_TRANSPORT_LIST} from '../../utils/routes';
        ...
        >
            <View style={styles.header}>
                ...
                <Text style={[
                    ...
                    {t('transportOrder.label.title')}
                </Text>
            </View>
            <TouchAction
                onPress={() => {
                    navigation.navigate(ROUTE_TRANSPORT_LIST)
                }}
                icon={require("./../../assets/images/list.png")}
                text={t('transportOrder.label.listTransport')}
            />
        </ContainerWrapper>
    )
}
export default TransportRoot;
